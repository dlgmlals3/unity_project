...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public void OnCreateRoomButtonClicked()
	{
        ...
        if (GameMode != null)
        {
            ...
            roomOptions.CustomRoomPropertiesForLobby = roomPropsInLoby;
	...
	{
        Debug.Log(PhotonNetwork.LocalPlayer.NickName + " jointed to " + PhotonNetwork.CurrentRoom.Name + 
