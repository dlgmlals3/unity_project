...
public class CustomTerrain : MonoBehaviour
{
    ...
    public void RandomTerrain()
    {
        ...
        Debug.Log("dlgmlals3  " + terrainData.heightmapResolution + " " + terrainData.heightmapResolution);
    ...
    public void LoadTexture()
    {
        ...
        for (int x = 0; x < terrainData.heightmapResolution; x++)
        {
            for (int z = 0; z < terrainData.heightmapResolution; z++)
            {
                Color color = heightMapImage.GetPixel(
                    (int)(x * heightMapScale.x),
                    (int)(z * heightMapScale.z));
                // Debug.Log("Color : " + color + " grayscale : " + color.grayscale);
                heightMap[x, z] = color.grayscale * heightMapScale.y;
            }
        }
        terrainData.SetHeights(0, 0, heightMap);
    }
